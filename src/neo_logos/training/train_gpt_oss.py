#!/usr/bin/env python3
"""
Neo-Logos Training on gpt-oss-20b

Fine-tunes OpenAI's gpt-oss-20b using Unsloth with Harmony format.
Follows the official Unsloth gpt-oss fine-tuning tutorial.

Usage:
    python -m neo_logos.training.train_gpt_oss --model_size 20B --epochs 3
    python -m neo_logos.training.train_gpt_oss --dataset path/to/training.jsonl
"""
...
def build_parser():
    ...
    parser.add_argument(
        ...
        default="20B", help="Model size preset"
    )
    parser.add_argument(
        "--dataset", type=str,
